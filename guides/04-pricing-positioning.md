...
### Value Proposition Design (Adjusted)
...
**Add:** Changes in the environment

What's happening in the world that makes your solution timely? AI? Cloud shift? Remote work?
...
**New Relic vs Datadog page:**
- Price comparison graphs
- CTAs focused on price comparison
- Category jargon: "peak usage," "overages," "SKUs"

If you win on price, own it explicitly.
...
**From marketing learnings post:**
"The fraction of innovators is way larger in developer audience than normal."

Developers are willing to try new things. Free tier enables that.
...
- Is there differentiation clear?
...
### Clarity
- [ ] What you do is clear in 10 words
- [ ] Who it's for is explicit
- [ ] Differentiator is obvious
- [ ] Category is appropriate

### Pricing Page
- [ ] 3 tiers max
- [ ] Free tier available
- [ ] Each tier has clear "for whom"
- [ ] Enterprise features visible
- [ ] CTAs prominent

### Messaging
- [ ] keyBoard content exists
- [ ] whiteBoard content exists
- [ ] Boardroom content exists
- [ ] Comparison pages exist

### Validation
- [ ] Tested with target developers
- [ ] Words match how users describe
- [ ] Differentiation resonates
...
[Subhead - how you're different or key benefit]
...
[What's included from lower tier]
[CTA]
```
...
**Positioning:**
- [Developer Product Positioning Examples That Slap](https://devpmm.substack.com/p/developer-product-positioning-and-messaging-examples-that-slap) — DevPMM Newsletter
- [Who to Address on the Dev Tool Homepage](https://www.markepear.dev/blog/who-to-address-on-the-dev-tool-homepage)
- [Selling to Developers (Users vs Buyers)](https://www.developermarkepear.com/blog/selling-to-developers)
- [Features vs Benefits in PLG](https://www.linkedin.com/feed/update/urn:li:activity:7062049437707075584/) — Anthony Pierri

**Pricing Pages:**
- [The DNA of a Great Pricing Page](https://www.elenaverna.com/p/the-dna-of-a-great-pricing-page) — Elena Verna
- [Pricing & Billing Teardowns (Linear, Supabase, Vercel, Mintlify, PostHog)](https://www.youtube.com/watch?v=niXp14D6DEc&list=PLaAbRmJj8zVozS8oKNZ2h81Qve9NmKCvg) — Schematic

**GTM Frameworks:**
- [1-2-3 Framework for GTM](https://www.heavybit.com/library/video/self-serve-go-to-market) — Adam Gross (Heavybit)
- [Bottom-Up vs Top-Down vs Middle-Out Discussion](https://news.ycombinator.com/item?id=34190966) — Hacker News

**Examples:**
- [Axiom](https://www.axiom.co/) — Competitor-focused positioning
- [Snyk's Narrow Initial Positioning](https://www.markepear.dev/example/snyk-narrow-initial-positioning)
