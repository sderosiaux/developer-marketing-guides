...
![09 Sales Signals](images/09-sales-signals.png)
...
**From HN discussion:**
> "Buy-then-build can be a great strategy. Going into a decision with the mindset readiness for 'then-build', you can learn from existing products, hit their limits and understand what the custom version you'll need."
...
### Product-Qualified Account Definition

```
Account qualifies for sales outreach when:

**Usage criteria (all required):**
- [ ] Active for 2+ weeks
- [ ] 3+ users in account
- [ ] Core feature adoption (define)
- [ ] Above [X] usage threshold

**ICP criteria (3+ required):**
- [ ] Company size: [range]
- [ ] Industry: [list]
- [ ] Tech stack: [relevant techs]
- [ ] Funding stage: [if relevant]
- [ ] Geo: [if relevant]
```

### Sales Outreach Email (Product Signal)

```
Subject: Re: your [Product] usage

Hi [Name],

I noticed your team at [Company] has been exploring [specific feature]
over the past few weeks.

Many teams at this stage find value in [enterprise feature] to
[specific benefit]. Would be happy to show you how.

Also, if you're running into any blockers, I can connect you with
our solutions team.
...
**GTM Frameworks:**
- [1-2-3 Framework for GTM](https://www.heavybit.com/library/video/self-serve-go-to-market) — Adam Gross (Heavybit)
- [Bottom-Up vs Top-Down vs Middle-Out](https://news.ycombinator.com/item?id=34190966) — HN Discussion
- [Build vs Buy Developer Psychology](https://news.ycombinator.com/item?id=34163624) — HN Discussion

**Product-Led Sales:**
- [PLG to Product-Led Sales Playbook](https://www.decibel.vc/content/a-playbook-to-go-from-product-led-growth-to-product-led-sales) — Gabriel Madureira
- [Who to Reach Out to in PLG Motion](https://www.linkedin.com/posts/theproductledgeek_sales-productledsales-plg-activity-7155895861095333889-vybZ) — Ben Williams
- [Product-Led Geek Newsletter](https://www.plg.news/) — Ben Williams

**Sales Signals:**
- [100+ List of Sales Signals](https://docs.google.com/spreadsheets/d/1Y3bbNPJ5tmOk2wlQO7ItWz3wzjM4tglPjlz6vnAqmwA/edit) — Kevin White (Common Room)
- [GitHub Signals Monitoring + 22% Response Rate](https://www.linkedin.com/posts/piyush-agarwal-reo_22-linkedin-response-rate-how-kubegrade-activity-7346179048877826048-FKBt)
- [How Apollo Fuels GTM with OSS Usage](https://www.decibel.vc/articles/how-apollo-fuels-its-gtm-engine-with-oss-usage-and-a-champions-community)

**Pipeline & Sales:**
- [Learnings from Datadog CMO](https://open.spotify.com/episode/2PNnZhL8agfBaWa2lfYmXJ) — On pipeline, attribution, anti-retention patterns
- [Best Automated GTM Plays](https://www.growthunhinged.com/p/automated-gtm-plays) — Kyle Poyar

**Tools:**
- [Syften](https://syften.com/) — Social listening
- [Common Room](https://www.commonroom.io/) — Developer signals
- [Reo.dev](http://Reo.dev) — Developer activity tracking
- [Clay](https://www.clay.com/) — Enrichment for GTM
