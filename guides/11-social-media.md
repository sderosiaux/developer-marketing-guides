...
Craft memes and jokes specifically for developer audience.

**2. Talk in dev jargon**
Don't dumb it down. Speak their language.

**3. Make tweets pop in the feed**
Even enterprise plan promotion can be engaging.
...
**1. Architecture diagrams + explanation**
Devs like diagrams. Complex concept in one visual = shareable.

**2. Personal founder stories**
Behind-the-scenes of building.

**3. Tactical learnings**
"What I learned doing X at [Company]"

**4. Controversial takes**
(Respectfully) challenge conventional wisdom.
...
**Why it works:**
Founders have authority developers respect. Technical founders especially.
...
Engagement rate more valuable than raw follower count.
Quality of comments more valuable than quantity.
...
### Product Announcement Tweet

```
Just shipped [feature] in [Product]!
...
Been working on this for [time] based on your feedback.
...
The biggest surprise was [unexpected learning].

What's next: [brief roadmap tease]

P.S. We're hiring [roles]. Link in comments.
```

### Architecture Diagram Post

```
How [thing] works at [Company]:

[Diagram image]

The key decision points:

→ [Decision 1]: We chose [X] because [reason]
→ [Decision 2]: [Same pattern]
→ [Decision 3]: [Same pattern]
...
**Twitter/X Strategy:**
- [Supabase Twitter Success Analysis](https://www.markepear.com/blog/supabase-social-media-strategy) — 28k+ followers breakdown
- [Lee Robinson on Developer Marketing](https://leerob.com/n/developer-marketing) — Vercel's approach

**LinkedIn Strategy:**
- [LinkedIn Ad Playbook for Dev Tools](https://www.linkedin.com/posts/tasbober_linkedin-ad-teardown-what-works-for-devtools-activity-7210323045196750848-jJbL) — Tas Bober
- [LinkedIn for B2B Developer Tools](https://www.developermarkepear.com/blog/linkedin-developer-marketing)

**Visual Content:**
- [Carbon](https://carbon.now.sh/) — Beautiful code images
- [Snappify](https://snappify.io/) — Code snippet sharing
- [Excalidraw](https://excalidraw.com/) — Hand-drawn diagrams
- [Whimsical](https://whimsical.com/) — Professional diagrams

**Social Listening:**
- [Syften](https://syften.com/) — Dev-focused social listening (Twitter, Reddit, HN, Slack)
- [SparkToro](https://sparktoro.com/) — Audience research (Rand Fishkin)

**Podcasts:**
- [PostHog on Founder-Led Social](https://open.spotify.com/episode/1VZwBZ5lBV6tUJZFXnPvZu) — James Hawkins
- [Social Strategy for Dev Tools](https://www.developermarkepear.com/podcast) — Markepear Podcast
