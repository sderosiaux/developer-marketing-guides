...
After the dinner, the CTA is to join Slack.
Relationship started IRL strengthens online.
...
High-influence people take calls when it's a podcast.
They might not otherwise talk to you.
...
We're a community of [who we are] helping each other [what we do].

**To get started:**
1. Introduce yourself in #introductions
2. Read the guidelines in #rules
3. Jump into discussions in [relevant channel]
...
### 1:1 Questions for New Members

```
1. What brought you to join the community?
2. What are you working on right now?
3. What do you hope to get from being here?
4. What's your area of expertise?
...
[Name] is a [role] at [company] who has been incredibly helpful
...
**Community Building:**
- [Business Value of Building Community](https://open.spotify.com/episode/0u7gsf0RRtPmTtxEAthoKh) — Patrick Woods (Orbit CEO)
- [Lee Robinson on Developer Marketing](https://leerob.com/n/developer-marketing) — Developer experience and community

**Product Hunt & Launches:**
- [Product Hunt Launch Playbook](https://www.reforge.com/artifacts/product-hunt-launch-checklist-by-matteo-tittarelli) — Matteo Tittarelli
- [How to Launch Dev Tools on ProductHunt](https://ronakganatra.com/successfully-launch-dev-tools-on-producthunt)

**Reddit Engagement:**
- [Great Reddit Post from Convex](https://www.markepear.com/developer-marketing-examples/great-reddit-post-from-convex) — Tom Redman

**Resources & Tools:**
- [Enterprise Founder Toolkit](https://boldstart.vc/devtoolkit/) — boldstart.vc
- [Alternative to NPS for Dev Tools](https://boldstart.vc/resources/an-alternative-to-nps-for-dev-tools/)
- [Dots](https://www.dots.so/) — Community automation platform

**Newsletters:**
- [DevPMM Newsletter](https://devpmm.substack.com/) — Marek Nalikowski
- [Going Deepear Into Dev Marketing](https://open.spotify.com/show/0wyxDG8BkClv5XltUiZdbD)
